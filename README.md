...
# ☁️ HomeTalk
<p align="center">
  <a href="https://www.hometalk.store" target="_blank">
    <img src="https://img.shields.io/badge/👉 Demo_Site-Click_to_View-green?style=for-the-badge" alt="Demo Site"/>
  </a>
  <br/><br/>
  <img src="https://github.com/user-attachments/assets/5102a120-3d0d-4aee-9f6a-eaa2c6430ec3" alt="preview" width="80%" />
</p>
...
- 📝 게시글 작성, 수정, 삭제 (CRUD)
- #️⃣ 게시글 태그 및 **지도 첨부 기능**
- ❤️ 게시글 좋아요 및 **댓글/답글 알림**
- 🔍 검색, 페이징, 내가 쓴 글/댓글 모아보기
- 🔐 **OAuth 로그인** (네이버, 구글)
